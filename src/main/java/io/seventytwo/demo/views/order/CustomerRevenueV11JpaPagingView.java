...
@Route(value = "customer-revenue-jpa-paging", layout = ApplicationLayout.class)
@PageTitle("Customer Revenue JPA Paging and Sorting")
public class CustomerRevenueV11JpaPagingView extends VerticalLayout {

    public CustomerRevenueV11JpaPagingView(CustomerRepository customerRepository) {
        setHeightFull();
        ...
        grid.setItems(query -> customerRepository.findAll(PageRequest.of(query.getPage(), query.getPageSize(), toSpringDataSort(query))).stream());
